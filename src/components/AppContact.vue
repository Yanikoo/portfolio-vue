<template>
  <div class="container">
    <h2 class="container__title">Связаться со мной</h2>
    <p class="container__text">Есть вопросы? Напишите мне и я обязательно отвечу!</p>

    <div class="container__block">
      <div class="container__card">
        <div class="container__card-icon">
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
          ...
          <p class="container__card-text">nickita.filiukov@mail.ru</p>
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
        ...
        <div class="container__card-icon">
          ...
          <p class="container__card-text">+7 (925) 902-46-80</p>
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
